...
- r18：`task_completed=true`，`status=SUCCESS`，reason=`route_completed_without_collision_or_illegal_lane_invasion`；
- route 4,977.1/4,995 m，0 碰撞、0 非法车道侵入、0 超速，横偏 0.083 m，15/15 条文本指令全部发出，c07 左转完成判定通过；
